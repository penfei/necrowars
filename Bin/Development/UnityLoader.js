...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 33351992;
      var PACKAGE_UUID = '96f54354-0077-471a-a95f-8dccba893f79';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 28901331, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(28901331, 28907734, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(28907734, 28907755, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(28907755, 28920259, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(28920259, 32449395, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(32449395, 33324367, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(33324367, 33351992, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          DataRequest.prototype.requests["/PlayerConnectionConfigFile"].onload();
